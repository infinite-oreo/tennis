/**
 * [INPUT]: 依赖 three（WebGL 流体模拟），依赖 react useEffect/useRef
 * [OUTPUT]: 导出 LiquidEther 全屏流体背景组件，colors/mouseForce/autoDemo 等参数可配置
 * [POS]: effects 层视觉特效，被 landing/Hero 作为全屏背景消费，pointer-events-none 不阻断交互
    ...
    class Simulation {
      ...
      createShaderPass() {
        ...
        this.viscous = new Viscous({
          ...
          dst: this.fbos.vel_viscous1, dst_: this.fbos.vel_viscous0,
          dt: this.options.dt
        });
