/**
 * [INPUT]: 无外部依赖，纯数据常量
 * [OUTPUT]: 对外提供 AFFILIATE_LINKS（品牌→链接映射）、AFFILIATE_CATEGORIES（需展示购买按钮的品类）
 * [POS]: data 层联盟营销数据源，被 PlayersPage 的 SponsorCard 消费
 * [PROTOCOL]: 变更时更新此头部，然后检查 CLAUDE.md
 *
 * ⚠️ 使用前请将每个链接替换为你自己的联盟专属 URL（含你的 ref/affiliate_id 参数）
 *    申请渠道：
...
// ─── 品牌联盟链接 ───────────────────────────────────────────────
// 替换为你的专属联盟 URL，格式示例：
// https://www.wilson.com/en-us/tennis?aff=YOUR_ID
export const AFFILIATE_LINKS = {
  'Nike':        'https://www.nike.com/tennis',
  'Wilson':      'https://www.wilson.com/en-us/sport/tennis',
  'Babolat':     'https://www.babolat.com/en',
  'Head':        'https://www.head.com/en/sports/tennis',
  'Adidas':      'https://www.adidas.com/us/tennis',
  'New Balance': 'https://www.newbalance.com/sport/tennis',
  'Tecnifibre':  'https://www.tecnifibre.com/en',
  'Lacoste':     'https://www.lacoste.com/us/sport/tennis',
  'Fila':        'https://www.fila.com/en-us/sport/tennis',
  'ON Running':  'https://www.on.com/en-us/sport/tennis',
